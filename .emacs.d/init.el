...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (expand-region evil neotree auto-complete-c-headers auto-complete yasnippet-snippets ggtags zygospore helm-gtags helm yasnippet ws-butler volatile-highlights use-package undo-tree iedit dtrt-indent counsel-projectile company clean-aindent-mode anzu))))
(custom-set-faces
...
;;map set-mark-command to 'C-c C-s'
...
;;Hight light symbol config
;;(require 'highlight-symbol)
;;(global-set-key [(control <b><b>f3)] 'highlight-symbol)
...
;;set back ground color and forground color
...
(global-set-key (kbd "C-x o") 'turn-off-evil-mode)
